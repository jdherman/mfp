...
pulse = {
  'FMD': {
    'FERC': {
      'W': [200,400,400,400,400,400,400,400,400,
            275,275,190,190,190,115,115,115,65,65,65,65],
      'AN': [200,400,400,275,275,190,190,190,115,115,115,65,65,65,65]
    },

    'increase_rampdown': {
      'W': [220,440,440,440,440,440,440,440,440,
            440,302.5,302.5,242,209,209,209,167.2,
            133.76,126.5,126.5,101.2,80.96,71.5,71.5,71.5,71.5],
      'AN': [220,440,440,352,302.5,302.5,242,209,209,
             209,167.2,133.76,126.5,126.5,101.2,80.96,
             71.5,71.5,71.5,71.5]
    },
    
    'increase_rampdown_BN': {
      'W': [220,440,440,440,440,440,440,440,440,
            440,302.5,302.5,242,209,209,209,167.2,
            133.76,126.5,126.5,101.2,80.96,71.5,71.5,71.5,71.5],
      'AN': [220,440,440,352,302.5,302.5,242,209,209,
             209,167.2,133.76,126.5,126.5,101.2,80.96,
             71.5,71.5,71.5,71.5],
      'BN': [220,379.5,379.5,302.5,302.5,302.5,242,209,209,209,
             167.2,133.76,126.5,126.5,101.2,80.96,71.5,71.5]
    }
  },
  ...
  'HHL': {
    'FERC': {
      ...
      'AN': [200,200,200,200,200,200,200,200,200,
             200,200,200,200,200,200,150,150,90,90,90]
    },

    'increase_rampdown': {
      'W': [220,220,220,220,220,220,220,220,220,220,
            220,220,220,220,220,220,220,220,220,220,
            220,220,220,220,220,220,220,220,220,220,
            220,220,220,220,220,220,176,165,132,105.6,99,99,99,99],
      'AN': [220,220,220,220,220,220,220,220,220,220,220,220,220,
             220,220,176,165,132,105.6,99,99,99,99]
    },
    ...
    'increase_rampdown_BN': {
      ...
      'AN': [220,220,220,220,220,220,220,220,220,220,220,220,220,
             220,220,176,165,132,105.6,99,99,99,99],
      'BN': [220,220,220,220,220,220,220,220,220,220,220,
             220,220,220,220,176,165,132,105.6,99,99,99,99]
    },

  }
}

# FMD: may 15th, may 7th, and idkyet. HHL uses May 1st for AN.
dowy_starts = {'FMD': {'W': 226, 'AN': 218, 'BN': 210},
               'HHL': {'W': 226, 'AN': 212, 'BN': 196}}

for r in ['FMD','HHL']:
  for scen in ['FERC', 'increase_rampdown']:
    for wyt in ['W', 'AN']:
      data = pulse[r][scen][wyt]
      dowy_start = dowy_starts[r][wyt]
      s = '%s_%s' % (r,scen)
      dowy_end = dowy_start + len(data)
      ix = (df.dowy >= dowy_start) & (df.dowy < dowy_end) & (df.WYT == wyt)
